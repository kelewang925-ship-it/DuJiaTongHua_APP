...
| --- | --- | --- | --- |
| 网络错误 | 网络连接失败，请重试 | 传信的小信使迷路了，再试一次吧~ | 小信使拍翅膀、虚线圈圈 |
| 删除确认 | 确定删除这条日记吗？不可恢复 | 要把这段回忆悄悄藏进小黑屋吗？ | 伤心小熊、纸张揉碎动画 |
| 表单校验 | 密码长度不能少于 6 位 | 我们的暗号太短啦，再多写几个字吧 | 摇晃的小锁 |
| AI 创作中 | 正在生成漫画 | 魔法画笔正在悄悄涂色... | 星光闪烁、翻书页 |
